...
type GatheringConfig struct {
	...
	// forceRefreshReason enables user to force or refresh specific actions in the Insights operator.
	// User can force the Insights data gathering by setting "Gathering" reason. User can also refresh
	// a cluster transfer status by setting "ClusterTransfer" reason.
	...
	ForceRefreshReason RefreshReason `json:"forceRefreshReason"`
...
const (
	...
	Gathering RefreshReason = "Gathering"

	ClusterTransfer RefreshReason = "ClusterTransfer"

	Empty RefreshReason = "Empty"
)
